...
<table class="table table-bordered">
	...
	<tr>
		...
		<a href="/product/list?pageNum=${cri.pageNum }&amount=${cri.amount }&type=${cri.type }&keyword=${cri.keyword }"
		 class="btn btn-outline-secondary">list</a>
		<a href="/product/modify?pno=${pvo.pno }&pageNum=${cri.pageNum }&amount=${cri.amount }&type=${cri.type }&keyword=${cri.keyword }"
			...
			<button type="button" class="btn btn-outline-danger" id="rmBtn">delete</button>
		</td>
	</tr>
</table>
<h2>comments<span class="badge badge-info">${pvo.commentcnt }</span></h2>
<form>
  <div class="input-group mb-3 input-group-lg">
    <div class="input-group-prepend">
      <span class="input-group-text" id="cmtWriter">${pvo.writer }</span>
    </div>    
    <input type="text" class="form-control" id="cmtText" placeholder="Write comments..">
    <div class="input-group-append">
    <button class="btn btn-success" type="button" id="cmtSubmit">submit</button>
  </div>
  </div>
</form>
